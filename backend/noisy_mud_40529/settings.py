"""
Django settings for noisy_mud_40529 project.
...
ROOT_URLCONF = 'noisy_mud_40529.urls'
...
WSGI_APPLICATION = 'noisy_mud_40529.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_mud_40529 API",
    "DESCRIPTION": "API documentation for noisy_mud_40529 App",
    "VERSION": "v1",
}
